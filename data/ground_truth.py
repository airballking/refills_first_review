...
def populate_ground_truth():
    ...
    s2_layer2 = complete_layer("s2_layer2", s2_layer1 , 0 , 0.102, 0.190, 
    ...
    s2_layer4 = complete_layer("s2_layer4", s2_layer3 , 0 , 0.145, 0.495, 
                                [], 
    ...
    s3_layer5 = complete_layer("s3_layer5", s3_layer4, 0 , 0, 0.335, 
                                [0.010, 0.098, 0.161, 0.261, 0.332, 0.426, 0.485, 0.597, 0.672, 0.750, 0.905, 0.983], 
    ...
    s4_layer2 = complete_layer("s4_layer2", s4_layer1, 0 , 0.102, 0.233, 
    ...
    s4_layer4 = complete_layer("s4_layer4", s4_layer3, 0 , 0, 0.253, 
                                [0.005, 0.041, 0.112, 0.185, 0.262, 0.330, 0.385, 0.488, 0.531, 0.579, 0.620, 0.671, 0.747, 0.826, 0.886, 0.972, 0.985], 
